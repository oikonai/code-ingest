...
from typing import TYPE_CHECKING, List, Literal, Optional, Set, Tuple, TypedDict, Union
...
# from vllm.model_executor.model_loader.utils import set_default_torch_dtype  # Unused, removed for vLLM nightly compat
